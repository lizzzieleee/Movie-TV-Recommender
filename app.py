...
# ==============================
def collect_discover(media_type="movie", pages=6, date_gte="2016-01-01", language="en") -> pd.DataFrame:
    rows = []
...
def quick_build_corpus(pages_movie=6, pages_tv=6) -> pd.DataFrame:
